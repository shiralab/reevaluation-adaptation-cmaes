...
class ObjectiveFunction(object):
    ...
    def __init__(self, target_eval, max_eval):
        ...
        self.mean_best_eval = np.inf if self.minimization_problem else -np.inf
    ...
    def info_header():
        ...
        :return: string list of header
        """
        return ['EvalCount', 'BestEval', 'meanBestEval']
    ...
    def info_list(self):
        ...
        :return: string list of evaluation count and best evaluation value
        """
        return ['%d' % self.eval_count, '%e' % self.best_eval, '%e' % self.mean_best_eval]
